...
// think / keepFold must not reset it) and finishes early on visible text +
// idle/result. Do not invent '(no response)' after 3s so completions steal
// the send. turnAbort still cancels the PTY; do not abort it for a timer.
