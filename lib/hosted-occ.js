 ...
 *
 * Canonical paths (iOS www/js/occ.js — do not rename, do not add /api/occ):
 *   POST /occ/sessions
 *   POST /occ/sessions/:id/messages   (SSE when stream:true; /goal is a message string)
 *   POST /occ/sessions/:id/files
 *   POST /occ/sessions/:id/stop
 * Android briefly shipped /api/occ/...; that client retargets here. /api/occ
 * is not a second primary API.
 */
